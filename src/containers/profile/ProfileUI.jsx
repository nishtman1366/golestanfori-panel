...
class ProfileUI extends Component {
  ...
  renderForm = () => {
    ...
    console.log("dasd", this.props.states.user);
    ...
    } else if (!this.props.states.user) {
      return (
              ...
              <Paper className={classes.paper}>
                <Grid item xs={12} justify="center" alignItems="center">
                  ...
                  >
                    ...
                    />
                    {this.props.states.user.image &&
                    this.props.states.user.image !== null ? (
                      <div>
                        <label htmlFor="raised-button-file">
                          <Avatar
                            // alt="Adelle Charles"
                            src={this.props.states.user.image}
                            style={{
                              position: "relative",
                              margin: "auto",
                              width: 48,
