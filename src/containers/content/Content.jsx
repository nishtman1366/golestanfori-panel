...
class Content extends Component {
  ...
  handleAddCategory = event => {
    ...
    ItookApi.addContentCategries(this.createFormData()).then(
      res => {
        console.log("res", res);
  ...
  handleEditCategory = event => {
    ...
    ItookApi.EditContentCategory(id, this.createEditFormData()).then(
      res => {
        // console.log("this.state.category", this.state.category);
        // console.log("this.state.category", this.state.category);
  ...
  handleDeleteCategories = () => {
    ...
    ItookApi.removeContentCategories(idsToBeRemoved).then(
      res => {
        if (res && res.status && res.status === 200) {
          // var categories = null;
