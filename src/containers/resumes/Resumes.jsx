/**
 * @description : Resumes Component is main component for rendering ResumesUI related.
 *
 * @method load
 * @method handleOpen
 * @method handleClose
...
import ResumesUI from "./ResumesUI";
...
class Resumes extends Component {
  ...
  handleClick = (event, id) => {
    ...
    if (event.target.tagName === "INPUT") {
      ...
      browserHistory.push("editResume/" + id);
    }
  };
  ...
  handleDeleteResumes = () => {
    ...
    ItookApi.removeResumes(idsToBeRemoved).then(
      res => {
        if (res && res.status && res.status === 200) {
          this.load();
          this.setState({
    ...
    if (this.state.isLoading) {
      ...
      component = (
        ...
        <ResumesUI
          ...
          OnDeleteResumes={this.handleDeleteResumes}
