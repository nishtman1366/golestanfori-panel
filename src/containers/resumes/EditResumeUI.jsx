...
class EditResumeUI extends Component {
  ...
  render() {
    console.log("openedResume", this.props.openedResume);
    return (
                  ...
                  {this.props.openedResume.image ? (
                    <div>
                      <label htmlFor="raised-pic1-file">
                        ...
                        >
                          <img
                            src={this.props.openedResume.image}
                            alt=""
                            style={{
                              maxHeight: "100%",
                              maxWidth: "100%",
                  ...
                  <Grid container justify="center" spacing={1}>
                    <Grid item xs={12} md={12}>
                      <TextField
                        ...
                        value={this.props.openedResume.name}
                        onChange={e => {
                    ...
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        type="number"
                        label="سال تولد"
                        value={this.props.openedResume.birth}
                        onChange={e => {
                          this.props.onChangeTextFieldData(
                            "birth",
                            e.target.value
                    ...
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        type="text"
                        label="محل تولد"
                        value={this.props.openedResume.birthLocation}
                        onChange={e => {
                          this.props.onChangeTextFieldData(
                            "birthLocation",
                            e.target.value
                    ...
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        type="text"
                        label="نام پدر"
                        value={this.props.openedResume.fatherName}
                        onChange={e => {
                          this.props.onChangeTextFieldData(
                            "fatherName",
                            e.target.value
                    ...
                    <Grid item xs={12} md={6}>
                      <TextField
                        ...
                        type="text"
                        label="سمت"
                        value={this.props.openedResume.lastJob}
                        onChange={e => {
                          this.props.onChangeTextFieldData(
                            "lastJob",
                            e.target.value
                ...
                <Grid container justify="center" spacing={1}>
                  <Grid item xs={12}>
                    ...
                    <Editor
                      ...
                      initialValue={this.props.openedResume.body}
                      // onChange={e => {
          ...
          <Grid container justify="center" spacing={2}>
            <Grid item xs={12} md={5}>
              ...
              <Editor
                ...
                initialValue={this.props.openedResume.jobRecords}
                // onChange={e => {
                //   this.props.onChangeTextFieldData(e.target.getContent());
                // }}
                onChange={e => {
            ...
            <Grid item xs={12} md={5}>
              ...
              <Editor
                ...
                initialValue={this.props.openedResume.educationRecords}
                // onChange={e => {
                //   this.props.onChangeTextFieldData(e.target.getContent());
                // }}
                onChange={e => {
          ...
          <Grid container justify="center" spacing={1}>
            <Grid item xs={12} md={5}>
              ...
              <Editor
                ...
                initialValue={this.props.openedResume.favorites}
                // onChange={e => {
                //   this.props.onChangeTextFieldData(e.target.getContent());
                // }}
                onChange={e => {
            ...
            <Grid item xs={12} md={5}>
              ...
              <Editor
                ...
                initialValue={this.props.openedResume.licenses}
                // onChange={e => {
                //   this.props.onChangeTextFieldData(e.target.getContent());
                // }}
                onChange={e => {
          ...
          <Grid container justify="center" spacing={1}>
            <Grid item xs={12} md={5}>
              ...
              <Editor
                ...
                initialValue={this.props.openedResume.scientificRecords}
                // onChange={e => {
                //   this.props.onChangeTextFieldData(e.target.getContent());
                // }}
                onChange={e => {
            ...
            <Grid item xs={12} md={5}>
              ...
              <Editor
                ...
                initialValue={this.props.openedResume.managementRecords}
                // onChange={e => {
                //   this.props.onChangeTextFieldData(e.target.getContent());
                // }}
                onChange={e => {
          ...
          >
            {this.props.busy ? (
              ...
              <Button
                ...
                onClick={this.props.onEditResume}
                style={{
                  fontFamily: "iransans",
                  fontSize: ".9rem",
                  background: "#2196F3",
