...
class EditContentsUI extends Component {
        ...
        <Grid container className={classes.root} justify="center" spacing={2}>
              ...
              <Grid container justify="center" spacing={2}>
                <Grid item xs={12} md={3}>
                  <TextField
                    ...
                    required
                    label="عنوان"
                    value={this.props.editContents.title}
                    onChange={e => {
                ...
                <Grid item xs={12} md={6}>
                  <TextField
                    ...
                    multiline
                    label="متن خلاصه"
                    value={this.props.editContents.lead}
                    onChange={e => {
              ...
              <div>
                <label htmlFor="raised-pic1-file">
                  ...
                  >
                    ...
                    <img
                      src={this.props.editContents.image}
                      alt=""
                      style={{
                        maxHeight: "100%",
                        maxWidth: "100%",
          ...
          <Grid item xs={12} md={7}>
            ...
            <Editor
              ...
              initialValue={this.props.editContents.body}
              // onChange={e => {
          ...
          >
            {this.props.busy ? (
              ...
              <Button
                ...
                onClick={this.props.onEditContent}
                style={{
                  fontFamily: "iransans",
                  fontSize: ".9rem",
                  background: "#2196F3",
